...
flat10 = Flat.create!(address:'The great wall of China',rating:8,price:1200,capacity:1000,facilities:'spiral staircase,large swimming pool', user:charles)
flat11 = Flat.create!(address:'Louvre',rating:8,price:1200,capacity:60000,facilities:'cat tunnel, Aquarium bed', user:henry)
flat12 = Flat.create!(address:'Moscow Kremlin',rating:8,price:1200,capacity:1000,facilities:'secret tunnel, spiral staircase', user:prometheus)
flat13 = Flat.create!(address:'Great Pyramid of Giza',rating:8,price:500000,capacity:1000,facilities:'spiral staircase,Aquarium bed', user:charles)
flat14 = Flat.create!(address:'Sydney Opera House',rating:8,price:1200,capacity:1000,facilities:'backyard cinema, secret tunnel', user:charles)
flat15 = Flat.create!(address:'Bolivian Sea Desert',rating:8,price:1200,capacity:1000,facilities:'flamingos, salt-water pool,', user:wilder)
flat16 = Flat.create!(address:'Maccu Piccu',rating:8,price:1200,capacity:1000,facilities:'vertical herb garden, secret tunnel', user:charles)
flat17 = Flat.create!(address:'Lake Como',rating:8,price:1200,capacity:1000,facilities:'backyard beach, secret-garden', user:prometheus)
flat18 = Flat.create!(address:'Lake Titicaca',rating:8,price:400000,capacity:1000,facilities:'door of swatches,swing set table', user:wilder)
flat19 = Flat.create!(address:'Eiffel Tower',rating:2,price:1200,capacity:1000,facilities:'ice cave,fire-pit table', user:wilder)
flat20 = Flat.create!(address:'Statue of Liberty',rating:2,price:1200,capacity:1000,facilities:'indoor-slide, ping-pong table', user:prometheus)
